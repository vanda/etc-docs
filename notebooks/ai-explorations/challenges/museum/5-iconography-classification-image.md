# 5. Iconography Classification (image level)

## Problem 

**Problem Statement**

Identify any iconography figure(s) depicted on a cultural heritage object from a digital image of the cultural heritage object.

...
Also known as: object identification

## Problem

**Problem Statement**

Identify those parts of an image of a cultural heritage object that contains depictions of "objects" and return bounding boxes for them with the classification of the object class depicted.
